      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-4">
          ...
          <div className="flex flex-col items-start md:items-end">
            <p className="text-white text-sm mb-3">Follow us to stay updated!</p>
            <div className="flex space-x-3">
              ...
              <Link 
                href="https://www.instagram.com/gdg.kolkata" 
                target="_blank" 
                rel="noopener noreferrer"
                className="text-white hover:text-gray-300 transition-colors"
              >
        ...
        <div className="flex flex-col md:flex-row justify-between items-center text-xs text-gray-300">
          <div className="mb-2 md:mb-0">
            <p>© GDG Kolkata X Google. All rights reserved.</p>
          </div>
          <div className="flex items-center">
            <Link href="https://gdg.community.dev/events/details/google-gdg-kolkata-presents-devfest-kolkata-2024/"  target="_blank" rel="noopener noreferrer" className="mr-2">DevFest Kolkata 2024</Link>
